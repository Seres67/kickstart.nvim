...
That's it! Lazy will install all the plugins you have. Use `:Lazy` to view the
...
> [!NOTE]
> For more information about a particular plugin check its repository's
> documentation.
...
2. install all requirements using choco, exit the previous cmd and open a new
   one so that choco path is set, and run in cmd as **admin**:
